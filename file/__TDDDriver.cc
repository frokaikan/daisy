/* TDD Driver from OUS
 * Compile Command : $LLVM_DIR/build_release/bin/clang++ -gdwarf-4 -fstandalone-debug -O0 -DNDEBUG -Xclang -disable-O0-optnone -fPIC -fsanitize=address,fuzzer -fprofile-instr-generate -fcoverage-mapping -std=c++17 -o __TDDDriver.exe __TDDDriver.cc -DHAVE_STRCASESTR -I ../../src -I . ./.libs/libmagic.so
 */
...
int __TDD_driver_main () {
    // Pointers
    __TDD_ptr.resize(5, nullptr);
    __TDD_ptr_size.resize(5, 0);
    ...
    nodes.push_back([&] () -> bool {
        int __TDD_tempVar_0 = static_cast<int>(0);
        magic_t __TDD_tempVar_1 = magic_open(__TDD_tempVar_0);
        if (!__TDD_tempVar_1) return false;
        __TDD_driver_set_ptr<magic_t>(0, __TDD_tempVar_1);
        return true;
    });
    nodes.push_back([&] () -> bool {
        ...
        if (!__TDD_driver_get_ptr<char*>(1)) return false;
        char* __TDD_tempVar_1 = static_cast<char*>(__TDD_driver_file_name());
        magic_load(__TDD_tempVar_0, __TDD_tempVar_1);
        return true;
    });
    nodes.push_back([&] () -> bool {
        if (!__TDD_driver_get_ptr<magic_set*>(0)) return false;
        magic_set* __TDD_tempVar_0 = static_cast<magic_set*>(__TDD_driver_get_typed_object<magic_set*>(0));
        magic_error(__TDD_tempVar_0);
        return true;
    });
    nodes.push_back([&] () -> bool {
        if (!__TDD_driver_get_ptr<magic_set*>(0)) return false;
        magic_set* __TDD_tempVar_0 = static_cast<magic_set*>(__TDD_driver_get_typed_object<magic_set*>(0));
        if (!__TDD_driver_get_ptr<char*>(2)) return false;
        char* __TDD_tempVar_1 = static_cast<char*>(__TDD_driver_get_typed_object<char*>(2));
        size_t __TDD_tempVar_2 = static_cast<size_t>(__TDD_ptr_size.at(2));
        if (!__TDD_driver_get_ptr<char*>(3)) return false;
        char* __TDD_tempVar_3 = static_cast<char*>(__TDD_driver_get_typed_object<char*>(3));
        size_t __TDD_tempVar_4 = static_cast<size_t>(__TDD_driver_get_typed_value<size_t>());
        file_printable(__TDD_tempVar_0, __TDD_tempVar_1, __TDD_tempVar_2, __TDD_tempVar_3, __TDD_tempVar_4);
        return true;
    });
    nodes.push_back([&] () -> bool {
        if (!__TDD_driver_get_ptr<magic_set*>(0)) return false;
