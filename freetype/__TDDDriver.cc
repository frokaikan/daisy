/* TDD Driver from OUS
 * Compile Command : $LLVM_DIR/build_release/bin/clang++ -gdwarf-4 -fstandalone-debug -O0 -DNDEBUG -Xclang -disable-O0-optnone -fPIC -fsanitize=address,fuzzer -fprofile-instr-generate -fcoverage-mapping -std=c++17 -o __TDDDriver.exe __TDDDriver.cc -I ../include -I ../include/freetype libfreetype.a -lz -lbz2 -lpng -lbrotlidec
 */
...
#endif
#define __TDD_DRIVER_MIN_SIZE 4096
#define __TDD_DRIVER_MAX_SIZE 4096
...
int __TDD_driver_main () {
    // Pointers
    __TDD_ptr.resize(7, nullptr);
    __TDD_ptr_size.resize(7, 0);
    ...
    // Graph
    TDD_Driver_Graph __TDD_graph(12);
    __TDD_graph.addEdge(0, 1);
    __TDD_graph.addEdge(1, 2);
    __TDD_graph.addEdge(2, 3);
    __TDD_graph.addEdge(3, 4);
    __TDD_graph.addEdge(4, 5);
    __TDD_graph.addEdge(5, 6);
    __TDD_graph.addEdge(6, 7);
    __TDD_graph.addEdge(0, 1);
    __TDD_graph.addEdge(1, 8);
    __TDD_graph.addEdge(8, 9);
    __TDD_graph.addEdge(9, 10);
    __TDD_graph.addEdge(10, 11);
    __TDD_graph.addEdge(11, 7);
    ...
    nodes.push_back([&] () -> bool {
        if (!__TDD_driver_get_ptr<FT_Library*>(0)) return false;
        FT_Library* __TDD_tempVar_0 = static_cast<FT_Library*>(__TDD_driver_get_typed_object<FT_Library*>(0));
        FT_Init_FreeType(__TDD_tempVar_0);
    ...
    nodes.push_back([&] () -> bool {
        ...
        FT_Long __TDD_tempVar_2 = static_cast<FT_Long>(__TDD_driver_get_typed_value<FT_Long>());
        if (!__TDD_driver_get_ptr<FT_Face*>(2)) return false;
        FT_Face* __TDD_tempVar_3 = static_cast<FT_Face*>(__TDD_driver_get_typed_object<FT_Face*>(2));
        FT_New_Face(__TDD_tempVar_0, __TDD_tempVar_1, __TDD_tempVar_2, __TDD_tempVar_3);
        return true;
    });
    nodes.push_back([&] () -> bool {
        if (!__TDD_driver_get_ptr<FT_Face>(3)) return false;
        FT_Face __TDD_tempVar_0 = static_cast<FT_Face>(__TDD_driver_get_typed_object<FT_Face>(3));
        FT_F26Dot6 __TDD_tempVar_1 = static_cast<FT_F26Dot6>(__TDD_driver_get_typed_value<FT_F26Dot6>());
        FT_F26Dot6 __TDD_tempVar_2 = static_cast<FT_F26Dot6>(__TDD_driver_get_typed_value<FT_F26Dot6>());
        FT_UInt __TDD_tempVar_3 = static_cast<FT_UInt>(__TDD_driver_get_typed_value<FT_UInt>());
        FT_UInt __TDD_tempVar_4 = static_cast<FT_UInt>(__TDD_driver_get_typed_value<FT_UInt>());
        FT_Set_Char_Size(__TDD_tempVar_0, __TDD_tempVar_1, __TDD_tempVar_2, __TDD_tempVar_3, __TDD_tempVar_4);
        return true;
    });
    nodes.push_back([&] () -> bool {
        if (!__TDD_driver_get_ptr<FT_Face>(3)) return false;
        FT_Face __TDD_tempVar_0 = static_cast<FT_Face>(__TDD_driver_get_typed_object<FT_Face>(3));
        FT_UInt __TDD_tempVar_1 = static_cast<FT_UInt>(__TDD_driver_get_typed_value<FT_UInt>());
        FT_UInt __TDD_tempVar_2 = static_cast<FT_UInt>(__TDD_driver_get_typed_value<FT_UInt>());
        FT_Set_Pixel_Sizes(__TDD_tempVar_0, __TDD_tempVar_1, __TDD_tempVar_2);
        return true;
    });
    nodes.push_back([&] () -> bool {
        if (!__TDD_driver_get_ptr<FT_Face>(3)) return false;
        FT_Face __TDD_tempVar_0 = static_cast<FT_Face>(__TDD_driver_get_typed_object<FT_Face>(3));
        FT_ULong __TDD_tempVar_1 = static_cast<FT_ULong>(__TDD_driver_get_typed_value<FT_ULong>());
        FT_Get_Char_Index(__TDD_tempVar_0, __TDD_tempVar_1);
        return true;
    });
    nodes.push_back([&] () -> bool {
        if (!__TDD_driver_get_ptr<FT_Face>(3)) return false;
        FT_Face __TDD_tempVar_0 = static_cast<FT_Face>(__TDD_driver_get_typed_object<FT_Face>(3));
        FT_UInt __TDD_tempVar_1 = static_cast<FT_UInt>(__TDD_driver_get_typed_value<FT_UInt>());
        FT_Int32 __TDD_tempVar_2 = static_cast<FT_Int32>(__TDD_driver_get_typed_value<FT_Int32>());
        FT_Load_Glyph(__TDD_tempVar_0, __TDD_tempVar_1, __TDD_tempVar_2);
        return true;
    });
    nodes.push_back([&] () -> bool {
        /*
    ...
    nodes.push_back([&] () -> bool {
        ...
        char* __TDD_tempVar_1 = static_cast<char*>(__TDD_driver_file_name());
        FT_Stream_Open(__TDD_tempVar_0, __TDD_tempVar_1);
        __TDD_driver_register_free([=] () -> bool {
            if (!__TDD_driver_get_ptr<FT_Stream>(4)) return false;
            FT_Stream __TDD_tempVar_0 = static_cast<FT_Stream>(__TDD_driver_get_typed_object<FT_Stream>(4));
    ...
    nodes.push_back([&] () -> bool {
        if (!__TDD_driver_get_ptr<FT_Library>(1)) return false;
        FT_Library __TDD_tempVar_0 = static_cast<FT_Library>(__TDD_driver_get_typed_object<FT_Library>(1));
        if (!__TDD_driver_get_ptr<char*>(6)) return false;
        char* __TDD_tempVar_1 = static_cast<char*>(__TDD_driver_get_typed_object<char*>(6));
        ...
        __TDD_driver_set_ptr<void*>(5, __TDD_tempVar_2);
        return true;
    });
    nodes.push_back([&] () -> bool {
        if (!__TDD_driver_get_ptr<FT_Stream>(4)) return false;
        FT_Stream __TDD_tempVar_0 = static_cast<FT_Stream>(__TDD_driver_get_typed_object<FT_Stream>(4));
        FT_ULong __TDD_tempVar_1 = static_cast<FT_ULong>(__TDD_driver_get_typed_value<FT_ULong>());
        FT_Stream_EnterFrame(__TDD_tempVar_0, __TDD_tempVar_1);
        return true;
    });
    nodes.push_back([&] () -> bool {
        /*
